...
- [ ] Install and try ~treemacs~ package
  #+begin_example
  $ sudo apt install treemacs
  In Emacs: M-x treemacs
  #+end_example

- [ ] Pi @ home: *"If you break it, you buy it."*
  #+begin_quote
...
- [ ] Complete the on-board Emacs tutorial
- [ ] [[https://lyon.schoology.com/assignment/5968463311][Programming assignment 1]]: Org-mode hello world[fn:5]
...
** "Should you get a CS degree or can you teach yourself?"

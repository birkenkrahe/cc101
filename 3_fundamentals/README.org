...
* Hello world program
** DONE "What a Tangled Web We Weave..."
...
- This function ~main~ is missing the ~void~ argument, and the ~int~
  (indicating the type of variable returned - an integer).
...
* Variable types and declarations
  ...
  * The block with *declarations* comes before the statements[fn:6]
...
** Library definitions with ~#include~
   ...
   * [X] Where is ~math.h~ in Windows[fn:12]? Where in MacOS? Find the file,
...
[fn:12]Look for it in the MinGW directory - there's an ~/include~
